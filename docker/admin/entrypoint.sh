...
# Script de entrada para el contenedor del Admin Panel
...
echo "Admin Panel iniciado correctamente"
echo "Sirviendo contenido desde: /usr/share/nginx/html"
echo "Puerto: 3001"

# Configuración de seguridad adicional para entorno de producción
if [ "$NODE_ENV" = "production" ]; then
    echo "Modo producción activado - configuraciones de seguridad habilitadas"
fi
